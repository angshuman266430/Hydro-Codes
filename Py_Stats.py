...
# After defining get_color_rating function
...
# Load datasets
df_dw = pd.read_csv('Modeled_results_DW.csv')
df_swe = pd.read_csv('Modeled_results_SWE.csv')
...
for metric in ['R\u00b2', 'NSE', 'RSR', 'PBIAS', 'RMSE (ft)', 'MAE (ft)']:
