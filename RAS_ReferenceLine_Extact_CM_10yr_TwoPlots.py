...
def plot_profile_time_series(data1, data2, names, data_type, output_folder, hdf_file_path1, hdf_file_path2):
    ...
    for time_step in range(num_time_steps):
        ...
        plt.plot(data_to_plot1, label='10yr with project high tide')
        plt.plot(data_to_plot2, label='10yr without project high tide')
...
# Parameters
hdf_file_paths = [
    "S:\\For_Angshuman\\Greenbelt\\ClientMeeting_HDFs\\10yr\\Greenbelt_RAS.p04.hdf",
    "S:\\For_Angshuman\\Greenbelt\\ClientMeeting_HDFs\\10yr\\Greenbelt_RAS.p05.hdf"
]
output_folder = "output_plots_10yr_with_without_project_High_tide"
